...
class DriveDataGenerator(image.ImageDataGenerator):
    def __init__(self,
                 ...
                 brighten_range=0,
                 **kwargs):
        # Set the custom brighten_range parameter
        if brighten_range != 0:
            kwargs['brightness_range'] = [1 - brighten_range, 1 + brighten_range]

        # Initialize the superclass with the updated kwargs
        ...
        # Store the custom parameter if needed
